...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-10-2017 a las 18:37:19
...
(14, 'Focus Whistler Pro ', '2017-10-19', '2017-10-10', 'Rondilla, Valladolid', 'Bicicleta robada en la cochera patio de la convivencia', 'Focus', 'Whistler Pro', 'Gris', '2016', '', '319432063', '', NULL),
(15, 'B-TWIN Rockrider 520 Nave Blue', '2017-07-18', '2017-06-27', 'El Vendrell, Tarragona', 'Fue robada el pasado martes 27/06/2017 en el garaje de casa', 'B-TWIN', 'Rockrider 520 Nave Blue', 'Negra y azul', '2017', '', NULL, '', NULL),
(16, 'Lapierre Sensium 200', '2017-05-23', '2017-05-20', 'Jerez de la frontera, Cádiz', 'Bicicleta de carbono de la marca Lapierre robada en Jerez de la frontera, Cádiz', 'Lapierre', 'Sensium 200', 'Negra y blanca', '2014', '', NULL, '', '99.99'),
(17, 'Santa Cruz Blur LT', '2017-05-28', '2017-05-08', 'El puerto de Santa Maria, Cádiz', 'Bicicleta robada en el barrio de Santa Maria, en un garaje comunitario', 'Santa Cruz', 'Blur LT', 'Naranja', NULL, '', NULL, '', NULL),
(18, 'Marin Bobcat Trail', '2017-04-27', '2017-04-20', 'Valencia', 'Robada de interior de bajo vivienda de un patio de vecinos rompiendo puerta de entrada al local', 'Marin', 'Bobcat Trail', 'Verde claro metalizado', '1996', '', NULL, '', NULL),
(19, 'Gazelle Primeur', '2017-02-12', '2017-02-08', 'Zona torre Acbar, Barcelona', 'Robada en la zona de la torre Acbar', 'Gazelle', 'Primeur', 'Azul oscuro', NULL, '', NULL, '', NULL),
(20, 'Seven Serius Unrivaled 8', '2017-01-12', '2017-01-10', 'Plaza del Pilar, Zaragoza', 'Bicicleta robada en la plaza del Pilar, tenía dos candados que rompieron', 'Seven', 'Serious Unrivaled 8', 'Blanco', NULL, '', NULL, '', '99.99'),
(21, 'Scott Scale 900 RC', '2017-01-24', '2016-12-23', 'Barrio de Montserrat, Barcelona', 'Me la robaron por el barrio de Montserrat mientras estaba haciendo unos recados', 'Scott', 'Scale 900 RC', 'Negra y amarilla', '2015', '', NULL, '', '99.99'),
(22, 'Fixie Aventón Cordoba ', '2016-12-10', '2016-12-05', 'Barcelona', 'Bicicleta robada en el párquing de bicis de la UPC Campus Nord', 'Fixie', 'Aventón Cordoba', 'Negra', '2016', '', 'AGDB15F0112', '', '50.00'),
(23, 'Cannondale Scalpel', '2016-11-21', '2016-11-13', 'San Lorenzo de El Escorial, Madrid', 'Robada en mi garaje personal por la noche', 'Cannondable', 'Scalpel', 'Roja y blanca', '2011', '', 'NM19920', '', NULL),
(24, 'Brompton H3R', '2014-12-20', '2014-11-16', 'Badalona, Barcelona', 'Robada en el trabajo ', 'Brompton', 'H3R', 'Naranja', '2014', '', '1405289944', '', '99.99'),
(25, 'Specialized S-Works Enduro', '2014-08-11', '2014-08-03', 'Bustarviejo, Madrid', 'Robada delante de mi casa, tenía 3 candados', 'Specialized', 'S-Works Enduro', 'Negro', '2004', '', NULL, '', '60.00'),
(26, 'Trek Jamis Dakar XCT 2.0', '2014-09-28', '2014-09-26', 'Alcobendas, Madrid', 'La robaron al descuido con forcejeo, me rompieron el hombro en el intento', 'Trek', 'Jamis Dakar XCT 2.0', 'Naranja', '2010', '', NULL, '', '99.99'),
(27, 'Peugeot Blue Lagoon', '2014-04-07', '2014-04-03', 'Atocha, Madrid', 'Robada en la calle Cañizares con Atocha, cerca de la Plaza Santa Ana', 'Peugeot', 'Blue Lagoon', 'Azul', '1991', '', NULL, '', '50.00'),
(28, 'Contini Mortirolo', '2014-01-28', '2014-01-25', 'Muskiz, Vizcaya', 'Posiblemente robada por rumanos de zona Cantabria', 'Contini', 'Mortirolo', 'Naranja y azul', '1980', '', NULL, '', '99.99'),
(29, 'KTM Ultra Sport', '2013-02-16', '2013-02-10', 'Vicálvaro, Madrid', 'La bici estaba candada en la señal que hay a la puerta del local y dos personas en scooter la robaron', 'KTM', 'Ultra Sport', 'Blanca', '2010', '', 'GT5643DF', '', '99.99'),
(30, 'Canyon Aeroad CF 9.0 ST', '2013-06-11', '2013-06-08', 'Madrid', 'Robada a modo de atraco en Madrid', 'Canyon', 'Aeroad CF 9.0 ST', 'Negra', '2011', '', NULL, '', '70.00');
