...
<body>
    ...
    <div class="ajuste">
        <div class="menu">
            <a href="..\index.htm" id="m_0" title="Inicio"></a>
            <a href="..\Tienda\Index.htm" id="m_1" title="Tienda online"></a>
            <a href="..\Morenito\Contacta.htm" id="m_4" title="Contacta"></a>
            <a href="..\Tienda\Outlet.htm" id="m_3" title="Outlet"></a>
            <a href="..\Tienda\Ofertas.htm" id="m_9" title="Ofertas"></a>
            <a href="..\Tienda\NovedadesMorenito.htm" id="m_10" title="Novedades"></a>
            <a href="..\Morenito\QuienesSomos.htm" id="m_2" title="Quiénes somos"></a>
            <a href="..\Morenito\NuestrasTiendas.htm" id="m_5" title="Nuestras tiendas"></a>
            <a href="..\Consejos.htm" id="m_7" title="Consejos"></a>
            <a href="Index.htm" id="m_8" title="Bicis Robadas"></a>
        ...
        <input type="text" id="palabra" value="Escribe aquí tu búsqueda" onclick="this.value=''" onkeypress="return clickenter(event)">
                    ...
                    <input type="button" class="buscar" value="" id="botonBuscar" onclick="return validarBuscador()">
...
<?php
            ...
            if(isset($_REQUEST['marca'])){
	         //   if($_REQUEST['marca']!=""){
	                    $q = "SELECT * FROM anunci WHERE anu_marca LIKE '%$_REQUEST[marca]%' AND anu_ubicacio_robatori LIKE '%$_REQUEST[ubi]%' AND anu_color LIKE '$_REQUEST[color]%' ORDER BY anu_data_robatori AND anu_titol LIKE '%$_REQUEST[nom]%' AND anu_model LIKE '%$_REQUEST[modelo]%' AND anu_numero_serie LIKE '%$_REQUEST[serie]%'";
	          //  } else {
              ...
              // echo "<b>SI HAY BICICLETAS QUE MOSTRAR<b><br/><br/>";
               while($anunci=mysqli_fetch_array($consulta)){
                   // echo "·Fecha de robo: $anunci[anu_data_robatori]<br/>  ";
                    ...
                    echo "<a>Número de serie: </a>$anunci[anu_numero_serie]<br/>  ";
...
<br>
		...
		<a>Marca</a>
		<div>
			<input required id="marca" name="marca" class="element text medium" type="text" maxlength="15" value=""/>
		</div>
<br>
